...
const ConsentAgreement = ({
  offset,
  navigateTo = 'navigate to the Advana App-wide Agreements on the About page',
  sendOkConsentClicked,
}) => {
  ...
  return (
    <StyledDialog
      ...
      <DialogContent>
        ...
        <Typography variant="body2" style={styles.margin}>OMB EXPIRATION DATE: 12/31/2023</Typography>
