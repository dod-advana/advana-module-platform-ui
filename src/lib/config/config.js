const configObject = {
    ...
    MEGA_MENU_ONE_LEVEL_SECTIONS: window?.__env__?.REACT_APP_MEGA_MENU_ONE_LEVEL_SECTIONS || process.env.REACT_APP_MEGA_MENU_ONE_LEVEL_SECTIONS || 'About, Applications, Learn, Support',
    MEGA_MENU_TWO_LEVEL_SECTIONS: window?.__env__?.REACT_APP_MEGA_MENU_TWO_LEVEL_SECTIONS || process.env.REACT_APP_MEGA_MENU_TWO_LEVEL_SECTIONS || 'Initiatives, Tools',
    ...
    MEGA_MENU_ENDPOINT: window?.__env__?.REACT_APP_MEGA_MENU_ENDPOINT || process.env.REACT_APP_MEGA_MENU_ENDPOINT || '/',
    ...
    BANNER_LINK: window?.__env__?.REACT_APP_BANNERS_ENDPOINT || process.env.REACT_APP_BANNERS_ENDPOINT || 'http://app.dev.advana.boozallencsn.com/api/banners/bannersEditor',
}
